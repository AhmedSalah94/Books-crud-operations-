...
namespace Books.Controllers
{
    public class BooksController : Controller
    {
        ...
        //طالما فى اول الفورم فى الفيو استخدمت @Html.AntiForgeryToken()
        //يبقى هستخدم دى هنا
        public ActionResult Save(BookFormViewModel model) //شعاله في الادد والابديت
        {
            ...
            if (model.Id == 0) //لو بتكريت كتاب جديد
            {
                var book = new Book
                {
                    Title = model.Title,
